...
\headers{Complexity with H{\"o}lder Continuous Gradients}{X. Chen, C. T. Kelley, and L. Wang}

% Title. If the supplement option is on, then "Supplementary Material"
% is automatically inserted before the title.
\title{Complexity of Projected Gradient Methods for Strongly Convex  Optimization with H{\"o}lder Continuous Gradient Terms\thanks{Submitted to the editors DATE.
