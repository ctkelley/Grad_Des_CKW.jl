...
Figure~\ref{fig:gd}. In this way we can directly compare the performace
...
has very irregular convergfence in the terminal phae of the iteration.

{\bf Xiaojun, Lei, any idea why this is. Lei, try other values of
$\tau_0$ to get a feel of the behavior of Algorithm 3.}
